	...
	<div id="login">
		<div class="header new-header">
			...
			<form action="doReg" method="post">
				<div class="box-form">
						<input type="text" class="phone" placeholder="邮箱 / 手机号" v-model="valueregin" name="phone">
						<input :type="makechang" class="password" v-model="makepassword" placeholder="密码" name="password">
						<input type="text" class="password" placeholder="昵称" v-model="valuename" name="username">
						<i :class="isshow ? 'newsee' : 'see'" v-on:click="change"></i>
						<button class="setlogin" v-on:click="setregin">下一步</button>
